...
(
	...
	'post_sold' => '**** 本內容購買後可見 ****',
	'post_banned' => '**** 作者被禁止或刪除 內容自動禁止 ****',
	'post_single_banned' => '**** 該文章被禁止 ****',
	'message_ishidden_hiddenreplies' => '此文章僅作者可見',
	'post_reply_quote' => '{author} 發表於 {time}',
	'post_edit' => "[i=s] 本文章最後由 {editor} 於 {edittime} 編輯 [/i]\n\n",
	'post_edit_regexp' => '/^\[i=s\] 本文章最後由 .*? 於 .*? 編輯 \[\/i\]\n\n/s',
	'post_edithtml' => '[i=s] 本文章最後由 {editor} 於 {edittime} 編輯 [/i]<br /><br />',
	'post_edithtml_regexp' => '/^\[i=s\] 本文章最後由 .*? 於 .*? 編輯 \[\/i\]&lt;br \/&gt;&lt;br \/&gt;/s',
	'post_editnobbcode' => '[ 本文章最後由 {editor} 於 {edittime} 編輯 ]\n\n',
	'post_editnobbcode_regexp' => '/^\[ 本文章最後由 .*? 於 .*? 編輯 \]\n\n/s',
	'post_reply' => '回覆',
	'post_thread' => '的文章',
	...
	'attach' => '附件',
	'attach_pay' => '收費附件',
	'attach_credits_policy' => '檢視積分策略說明',
	'attach_img' => '圖片附件',
	'attach_readperm' => '閱讀權限',
	'attach_img_zoom' => '點選在新視窗檢視全圖\\nCTRL+滑鼠滾輪放大或縮小',
	'attach_img_thumb' => '點選在新視窗檢視全圖',
	...
	'trade_waitsellerconfirm' => '交易已建立，等待賣家確認',
	...
	'trade_message_4' => '可輸入付款方式、銀行帳號等訊息',
	'trade_message_5' => '可輸入發貨公司、發貨單號等訊息',
	'trade_message_13' => '可輸入發貨公司、發貨單號等訊息',
	...
	'formulaperm_digestposts' => '精華文章數',
	'formulaperm_posts' => '發文數',
	'formulaperm_threads' => '主題數',
	'formulaperm_oltime' => '上線時間(小時)',
	'formulaperm_pageviews' => '頁面瀏覽量',
	'formulaperm_and' => '並且',
	'formulaperm_or' => '或者',
	'formulaperm_extcredits' => '自訂積分',
	...
	'modcp_logs_action_member' => '會員管理',
	'modcp_logs_action_forumaccess' => '會員權限',
	'modcp_logs_action_thread' => '主題管理',
	'modcp_logs_action_forum' => '版區管理',
	'modcp_logs_action_announcement' => '公告',
	'modcp_logs_action_log' => '管理記錄',
	...
	'click_here' => '點選這裡',
	'uch_createalbum' => '建立自己的相簿吧！',

	'pm_from' => '寄件人',
	'pm_to' => '收件人',
	'pm_date' => '日期',

	'share_message' => '您好！我在 {$_G[\'setting\'][\'bbname\']} 看到了這篇文章，認為很有價值，特推薦給您。\\n\\n$thread[\'subject\']\\n網址 [url={$threadurl}]{$threadurl}[/url]\\n\\n希望您會喜歡',
	...
	'perms_allowhighlightthread' => '主題醒目提示',
	...
	'perms_alloweditpost' => '編輯文章',
	'perms_allowwarnpost' => '警告文章',
	'perms_allowbanpost' => '禁止文章',
	'perms_allowdelpost' => '刪除文章',
	'perms_allowviewreport' => '檢視會員回報',
	'perms_allowmodpost' => '審核文章',
	'perms_allowmoduser' => '審核會員',
	'perms_allowbanuser' => '禁止會員',
	'perms_allowbanip' => '禁止 IP',
	'perms_allowedituser' => '編輯會員',
	'perms_allowmassprune' => '批量刪文',
	'perms_allowpostannounce' => '發佈公告',
	'perms_disablepostctrl' => '發文不受限制',
	'perms_allowviewip' => '允許檢視 IP',
	'perms_viewperm' => '瀏覽版區',
	'perms_postperm' => '發新話題',
	...
	'perms_allowstatdata' => '檢視統計資料報表',
	'perms_allowstat' => '允許檢視趨勢統計',
	'perms_allowpostarticle' => '發表文章',
	'perms_raterange' => '允許參與評分',
	'perms_allowcommentpost' => '允許參與評論',
	'perms_allowat' => '允許 @ 的人數',
	'perms_allowreplycredit' => '允許設定回覆文章獎勵',
	'perms_allowposttag' => '允許使用標籤',
	'perms_allowcreatecollection' => '允許建立淘專輯的數量',
	'perms_allowsendpm' => '允許發短訊',
	'perms_maximagesize' => '單張圖片最大大小',
	...
	'report_msg_your' => '您的 ',
	'report_noreward' => '不獎懲',
	'activity_viewimg' => '點選檢視',

	'crime_postreason' => '{reason} &nbsp; <a href="forum.php?mod=redirect&goto=findpost&pid={pid}&ptid={tid}" target="_blank" class="xi2">檢視更多資訊</a>',
	'crime_reason' => '{reason}',

	'connectguest_message_search' => array('尚未登入', '先登入'),
	'connectguest_message_replace' => array('尚未 <a href="member.php?mod=connect" class="xi2">完善帳號資料</a> 或 <a href="member.php?mod=connect&ac=bind" class="xi2">綁定已有帳號</a> ', '先 <a href="member.php?mod=connect" class="xi2">完善帳號資料</a> 或 <a href="member.php?mod=connect&ac=bind" class="xi2">綁定已有帳號</a> '),
	'connectguest_message_mobile_search' => array('尚未登入', '先登入'),
