...
(
	...
	'member_complete_var_act_userapp' => '增加漫遊應用',
	'member_complete_var_num' => '執行動作次數下限',
	'member_complete_var_num_comment' => '會員需要執行對應動作的最少次數',
	...
	'task_complete_act_favorite' => '收藏 {value} 篇主題',
	'task_complete_act_magic' => '使用 {value} 次道具。<br />您可以在文章頁面、網誌頁面、圖片頁面等使用道具',
);
