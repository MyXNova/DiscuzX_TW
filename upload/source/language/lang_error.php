...
(
	...
	'suggestion' => '如果您是網站管理員，建議您嘗試在管理中心 <a href="admin.php?action=tools&operation=updatecache&frames=yes" target="_blank">更新快取</a> ，或憑完整截圖透過 <a href="https://www.dismall.com/" target="_blank" rel="noreferrer">官方論壇</a> 尋求幫助。如果您確定是程式自身 Bug，您也可直接 <a href="https://gitee.com/discuz/DiscuzX/issues" target="_blank" rel="noreferrer">送出 Issue</a> 給我們',
