...
<ol>
   ...
   <li>禁止在騰訊雲產品的整體或任何部分基礎上以發展任何衍生版本、修改版本或第三方版本用於重新分發。</li>
...
<ol>
   ...
   <li>官方應用中心無法全面監控由第三方上傳至應用中心的應用程式，因此不保證應用程式的合法性、安全性、完整性、真實性或品質等；您從應用中心下載應用程式時，同意自行判斷並承擔所有風險，而不依賴於騰訊雲公司及官方應用中心。但在任何情況下，官方應用中心有權依法停止應用中心服務並採取相應行動，包括但不限於對於相關應用程式進行移除，暫停服務的全部或部分，保留相關記錄，並向有關機關報告。由此對您及第三人可能造成的損失，騰訊雲公司及官方應用中心不承擔任何直接、間接或者連帶的責任。</li>
   <li>騰訊雲公司對騰訊雲提供的軟體和服務之及時性、安全性、準確性不作擔保，由於不可抗力因素、騰訊雲公司無法控制的因素（包括駭客攻擊、停斷電等）等造成軟體使用和服務中止或終止，而給您造成損失的，您同意放棄追究騰訊雲公司責任的全部權利。</li>
   <li>騰訊雲公司特別提請您注意，騰訊雲公司為了保障公司業務發展和調整的自主權，騰訊雲公司擁有隨時經或未經事先通知而修改服務內容、中止或終止部分或全部軟體使用和服務的權利，修改會公佈於騰訊雲公司網站相關頁面上，一經公佈視為通知。騰訊雲公司行使修改或中止、終止部分或全部軟體使用和服務的權利而造成損失的，騰訊雲公司不需對您或任何第三方負責。</li>
</ol>
...
<p align="right">Discuz!</p>
	...
	'unstable_tips' => '您好，您使用的版本為非正式版本，可能存在未知的 Bug 或漏洞，如果您計畫正式建站或購買插件建議您使用最新正式 UTF-8 版本安裝。',
