/*
 參數
 parent			放置瀑布流元素的容器，預設為 $("waterfall")
 container		放置瀑布流的父容器，預設為 $("threadlist")
 maxcolumn		最多多少列，預設為 0 不限制
 space			圖片間距，預設為 10
 index			從第幾張開始排列，預設為 0
 tag			瀑布流元素的 tagName，預設為 li
 columnsheight	存放列高度的數組

 返回值
 index			目前瀑布流已經排列了多少張圖片
 totalwidth		目前瀑布流的總寬度
 totalheight	目前瀑布流的總高度
