...
function loadcalendar() {
	...
	s += '<th colspan="5" style="text-align: center"><a href="###" onclick="showdiv(\'year\');_cancelBubble(event)" title="點此選擇年份" id="year"></a>&nbsp; - &nbsp;<a id="month" title="點此選擇月份" href="###" onclick="showdiv(\'month\');_cancelBubble(event)"></a></th>';
